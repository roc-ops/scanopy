...
| 192.168.7.226 | switch-fdb-only-01 | v2c | community `netdefault` | Bridge FDB served, no LLDP remote table at all (see below) |
...
> `.226` is the next free address below that.

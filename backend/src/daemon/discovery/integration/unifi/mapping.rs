...
mod tests {
    ...
    fn a_controller_port_id_that_is_not_a_name_is_refused() {
        ...
        assert_eq!(
            candidate(&refused).and_then(|c| c.lldp_port_id.clone()),
            None
        );
        assert_eq!(
            candidate(&refused).and_then(|c| c.lldp_chassis_id.clone()),
        ...
        assert_eq!(
            candidate(&padded).and_then(|c| c.lldp_port_id.clone()),
        ...
        assert_eq!(
            candidate(&good).and_then(|c| c.lldp_port_id.clone()),
